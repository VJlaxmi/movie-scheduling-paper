...
Even the single-objective variant (minimizing cost only) requires searching over $n!$ scene orderings subject to capacity, precedence, and availability constraints.
