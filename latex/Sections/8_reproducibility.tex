...
Instance parameters (number of scenes, actors, locations, planning horizon) are documented in Table~\ref{tab:instances}.
The generator produces consistent actor availability calendars, location compatibility matrices, and scene-actor assignment matrices.
