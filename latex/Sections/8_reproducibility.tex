...
The generator produces consistent actor availability calendars, location compatibility matrices, scene-actor assignment matrices, town-location mappings, and all parameters required for the 19 constraint families of Section~\ref{sec:formulation}.
